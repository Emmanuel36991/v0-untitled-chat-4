            ...
            <div className="flex justify-center lg:justify-end">
              <Card className="w-full max-w-md bg-white/90 backdrop-blur-xl border-0 shadow-2xl card-enhanced animate-scale-in">
                ...
                <CardContent className="space-y-6">
                  <form onSubmit={handleSignUp} className="space-y-4 form-container">
                    {error && (
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 h-11 border-2 focus:border-purple-500 bg-white/80"
                          disabled={isLoading}
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <Input
                          ...
                          className="pl-10 pr-10 h-11 border-2 focus:border-purple-500 bg-white/80"
                          disabled={isLoading}
                        />
                        <button
                          type="button"
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-white px-2 text-slate-500 font-sans">Or</span>
                    </div>
                  </div>
