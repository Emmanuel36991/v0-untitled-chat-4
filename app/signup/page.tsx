      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          <div className="absolute bottom-[20%] left-1/2 -translate-x-1/2 max-w-md animate-float-delayed">
            <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-6 shadow-2xl">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-emerald-400 to-teal-600 flex items-center justify-center flex-shrink-0 text-white font-bold text-lg">
                  S
                </div>
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-white/70 text-xs font-medium">Sarah Chen</p>
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 py-12">
          ...
          <p className="text-lg text-white/70 mb-10 max-w-md leading-relaxed">
            Create your free account and join the community of traders who are
            taking control of their trading performance.
          </p>

          <div className="flex items-center gap-6">
            <div className="flex -space-x-3">
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-purple-400 to-purple-600 border-2 border-slate-900 flex items-center justify-center text-white text-sm font-medium">TM</div>
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 border-2 border-slate-900 flex items-center justify-center text-white text-sm font-medium">RK</div>
              <div className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 border-2 border-slate-900 flex items-center justify-center text-white text-sm font-medium">LP</div>
            ...
            <p className="text-white/60 text-sm">Join 5,000+ successful traders</p>
          </div>
        </div>
      </div>
