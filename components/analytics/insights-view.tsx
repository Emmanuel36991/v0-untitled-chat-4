        ...
        <div className="space-y-8 pb-10">
            ...
            <div>
                ...
                <Tabs defaultValue="setups" className="space-y-8">
                    ...
                    <TabsList className="bg-white dark:bg-slate-900 p-1 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm inline-flex h-auto w-full md:w-auto overflow-x-auto">
