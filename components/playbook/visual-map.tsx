  ...
  return (
    <Card className={cn("overflow-hidden border-border/60 bg-card shadow-xl", className)}>
      ...
      <CardContent className="p-0 relative h-[500px]" ref={containerRef}>
        ...
        {/* --- LEGEND (Bottom Left) --- */}
        <div className="absolute bottom-4 left-4 z-20 flex gap-3 text-2xs font-mono text-muted-foreground bg-background/70 backdrop-blur-sm px-3 py-2 rounded-lg border border-border/30">
        ...
        <div className="absolute top-4 left-4 z-20 flex items-center gap-2 text-2xs font-mono text-muted-foreground bg-background/50 backdrop-blur-sm px-2.5 py-1.5 rounded-md border border-border/20">
