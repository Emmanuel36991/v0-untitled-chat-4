...
import { PulseIcon, UpdatesIcon } from "@/components/icons/system-icons"
  ...
  return (
    <>
      <Button
        ...
        onClick={handleOpen}
        className={cn(
          "flex gap-2.5 items-center rounded-full h-10 px-4 text-sm font-semibold transition-all duration-300 border",
          hasUnreadUpdates
      ...
      >
        ...
        <span className="uppercase tracking-wider text-[10px] font-bold">Updates</span>
