...
import Link from "next/link" // Keep for text links, but NOT for buttons
...
export default function LoginPage() {
  ...
  return (
    // Outer suppression for general extension noise
    <div className="min-h-screen relative overflow-hidden bg-white text-slate-900" suppressHydrationWarning>
      
      {/* Background isolated at the bottom with no pointer events to prevent interference */}
              ...
              <CardContent className="space-y-6">
                <form onSubmit={handleLogin} className="space-y-5">
                  ...
                  <div className="space-y-2">
                    ...
                    {/* Protection 1: Suppress hydration on the input container */}
                  ...
                  <div className="space-y-2">
                    ...
                    {/* Protection 2: Suppress hydration on the input container */}
                    <div className="relative" suppressHydrationWarning>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {/* This Link is fine because it contains text, not a button */}
                ...
                <div className="text-center mt-4">
                  {/* CRITICAL FIX: Removed <Link> wrapper. Using onClick navigation instead. */}
                  <Button 
                    variant="ghost" 
